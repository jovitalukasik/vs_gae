...
class GNNDecoder(nn.Module):  
    def __init__(self, ndim, gdim, num_gnn_layers, num_node_atts):
        super().__init__()
        self.ndim = ndim
        self.gdim = gdim
        self.num_gnn_layers=num_gnn_layers
...
class GNNVAE(nn.Module):
    def __init__(self, ndim, gdim, num_gnn_layers, num_node_atts, beta, model_config):
        super().__init__()
        self.ndim= ndim
        self.gdim=gdim
        self.num_gnn_layers=num_gnn_layers
        ...
        self.Encoder = GNNEncoder(ndim, gdim, num_gnn_layers, num_node_atts)
        self.Decoder = GNNDecoder(ndim, gdim, num_gnn_layers, num_node_atts)
